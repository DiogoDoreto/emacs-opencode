# Capability: Session URL

## Purpose

Constructs browser URLs for navigating to OpenCode sessions. Supports linking to existing sessions or triggering automatic new-session creation via the web UI.
