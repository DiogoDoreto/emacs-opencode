...
Provides the core HTTP communication layer for the OpenCode Emacs SDK. Exposes configuration for the OpenCode server base URL and async helper functions for interacting with the OpenCode HTTP API, including session listing and creation.
